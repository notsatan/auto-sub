...
# This script will generate binaries for the multiple OS/architectures, and a text file
# containing the SHA256 checksums for the binaries generated

# Directory where the binaries will be generated - will be created if does not exist
bin_path="./bin"

# File containing checksums - just the file name, file will be present in `bin_path`
